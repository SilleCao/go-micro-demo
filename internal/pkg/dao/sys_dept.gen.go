...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.Pids = field.NewString(tableName, "pids")
	_sysDept.Name = field.NewString(tableName, "name")
	_sysDept.Sort = field.NewInt32(tableName, "sort")
	_sysDept.Creator = field.NewInt64(tableName, "creator")
	_sysDept.CreateDate = field.NewTime(tableName, "create_date")
	_sysDept.Updater = field.NewInt64(tableName, "updater")
	_sysDept.UpdateDate = field.NewTime(tableName, "update_date")
...
type sysDept struct {
	...
	Pids       field.String // 所有上级ID，用逗号分开
...
func (s *sysDept) updateTableName(table string) *sysDept {
	...
	s.Pids = field.NewString(table, "pids")
