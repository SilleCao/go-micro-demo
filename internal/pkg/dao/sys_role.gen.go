...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.Creator = field.NewInt64(tableName, "creator")
	_sysRole.CreateDate = field.NewTime(tableName, "create_date")
	_sysRole.Updater = field.NewInt64(tableName, "updater")
	_sysRole.UpdateDate = field.NewTime(tableName, "update_date")
