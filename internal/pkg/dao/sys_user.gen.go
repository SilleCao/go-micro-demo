...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.HeadURL = field.NewString(tableName, "head_url")
	...
	_sysUser.SuperAdmin = field.NewInt32(tableName, "super_admin")
	_sysUser.Status = field.NewInt32(tableName, "status")
	_sysUser.Creator = field.NewInt64(tableName, "creator")
	_sysUser.CreateDate = field.NewTime(tableName, "create_date")
	_sysUser.Updater = field.NewInt64(tableName, "updater")
	_sysUser.UpdateDate = field.NewTime(tableName, "update_date")
...
type sysUser struct {
	...
	Gender     field.Int32  // 性别   0：男   1：女    2：保密
	Email      field.String // 邮箱
	Mobile     field.String // 手机号
	DeptID     field.Int64  // 部门ID
	SuperAdmin field.Int32  // 超级管理员   0：否   1：是
